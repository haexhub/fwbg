...
class ProgressTracker:
    ...
    def _render(self):
        ...
        # ETA berechnen
        if self.completed_assets > 0 and self.completed_assets < self.total_assets:
            per_asset = elapsed / self.completed_assets
            remaining = (self.total_assets - self.completed_assets) * per_asset
